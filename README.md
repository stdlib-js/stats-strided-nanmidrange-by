...
```javascript
import nanmidrangeBy from 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-strided-nanmidrange-by@deno/mod.js';
```
The previous example will load the latest bundled code from the deno branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/stats-strided-nanmidrange-by/tags). For example,

```javascript
import nanmidrangeBy from 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-strided-nanmidrange-by@v0.1.1-deno/mod.js';
```

You can also import the following named exports from the package:

```javascript
import { ndarray } from 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-strided-nanmidrange-by@deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/stats-strided-nanmidrange-by/actions/workflows/test.yml/badge.svg?branch=v0.1.1
[test-url]: https://github.com/stdlib-js/stats-strided-nanmidrange-by/actions/workflows/test.yml?query=branch:v0.1.1
